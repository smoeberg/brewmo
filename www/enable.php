<?php
// Enable Brewmo module by force (entity=1 by default). Requires admin rights.
$res=0;
...
dolibarr_set_const($db, 'MAIN_MODULE_BREWMO', '1', 'chaine', 0, '', $e);
header('Content-Type: text/plain; charset=UTF-8');
echo "MAIN_MODULE_BREWMO=1 for entity=".$e."\nDone. Go to Setup -> Modules and refresh.";
